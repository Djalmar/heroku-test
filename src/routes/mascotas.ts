...
export function routes(app: Express) {
  ...
  app.get('/api/mascotas/avistadas', MascotaController.MascotaGet.findAvistadas)
  app.get('/api/mascotas/perdidas', MascotaController.MascotaGet.findPerdidas)
  app.get('/api/mascotas/encontradas', MascotaController.MascotaGet.findEncontradas)
  ...
  /**
* @api {get} /mascotas/perdidas Listar mascotas perdidas
* @apiName GetMascotaPerdida
* @apiGroup Mascota
*
...
* @apiSuccess {String} estado Estado perdido de la mascota.
*
...
*/
  ...
  /**
* @api {get} /mascotas/avistadas Listar mascotas avistadas
* @apiName GetMascotaAvistada
* @apiGroup Mascota
*
* @apiSuccess {String} id Id de la mascota.
* @apiSuccess {String} nombre Nombre de la mascota.
...
*/
  ...
  /**
* @api {get} /mascotas/encontradas Listar mascotas encontradas
* @apiName GetMascotaEncontrada
* @apiGroup Mascota
*
* @apiSuccess {String} id Id de la mascota.
* @apiSuccess {String} nombre Nombre de la mascota.
...
* @apiSuccess {Boolean} sexo Sexo de la mascota.
* @apiSuccess {String} estadoSalud Estado de salud de la mascota.
* @apiSuccess {String} estado Estado encontrado de la mascota.
*
* @apiSuccessExample Success-Response:
*     HTTP/1.1 200 OK
*[  {
